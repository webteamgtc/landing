...
export default function Footer() {
    ...
    <footer className="bg-gradient-to-r from-[#1F2F89] to-[#071145] text-white">
      <div className="mx-auto max-w-7xl py-8 md:py-10 px-4">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-center justify-between bg-[#ffffff57] rounded-xl p-3">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3">
                {socialLinks.map((item) => (
                  <a
                    ...
                    className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center rounded-md text-white  transition-transform duration-300 hover:-translate-y-0.5"
                  >
           ...
           <div className="flex flex-row gap-4 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center rounded-lg px-3 hover:opacity-90 transition-opacity bg-[#111e62]"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center  rounded-lg px-3 py-2 hover:opacity-90 transition-opacity bg-[#111e62]"
  ...
  <p className="text-[#D79A57] font-medium">
