...
export default function MobileButton({ variant = "primary", size = "md", className, children, as: Tag = "button", ...props }) {
  const handleClick = (e) => {
    e.preventDefault?.();
...
MobileButton.variants = variants;
MobileButton.sizes = sizes;