...
const variants = {
  ...
  hero: "text-[37px] md:text-[56px] font-semibold leading-[1.03] tracking-[-0.03em] text-white",
  /** Section title on dark background, centered */
  sectionDark:
    "text-center text-[32px] font-semibold leading-[1.12] tracking-[-0.02em] text-[#fff] md:text-[42px]",
  /** Section title on light background, centered */
  sectionLight:
    "text-center text-[32px] font-semibold leading-[1.12] tracking-[-0.02em] text-[#000] md:text-[42px]",
  ...
  card:
    "text-[18px] font-semibold leading-[1.2] tracking-[-0.02em] text-[#000] md:text-[19px]",
